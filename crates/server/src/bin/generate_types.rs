...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        api_types::LocalUser::decl(),
        api_types::AuthSession::decl(),
        api_types::LoginRequest::decl(),
        api_types::SetupRequest::decl(),
        api_types::LoginResponse::decl(),
        api_types::AuthStatusResponse::decl(),
        api_types::LocalCurrentUserResponse::decl(),
        api_types::ChangePasswordRequest::decl(),
        api_types::CreateUserRequest::decl(),
        api_types::UpdateUserRequest::decl(),
        api_types::UserResponse::decl(),
        api_types::UserListResponse::decl(),
